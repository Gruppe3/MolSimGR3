...
\item 
class \hyperlink{singletonutils_1_1Vector}{utils\+::\+Vector$<$ type, length $>$}
\item 
class \hyperlink{singletonutils_1_1Vector}{utils\+::\+Vector$<$ type, length $>$}
...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$typename type , int length$>$ }\\std\+::ostream \& \hyperlink{Vector_8h_a7e86748c491528fd8005aa230203d7e4}{operator$<$$<$} (std\+::ostream \&stream, const \hyperlink{singletonutils_1_1Vector}{utils\+::\+Vector}$<$ \hyperlink{classtype}{type}, length $>$ \&v)
\item 
{\footnotesize template$<$typename type , int length$>$ }\\\hyperlink{singletonutils_1_1Vector}{utils\+::\+Vector}$<$ \hyperlink{classtype}{type}, length $>$ \hyperlink{Vector_8h_afda25e1a1a50d5a1c65f5f1427fc3a99}{operator$\ast$} (double scalar, const \hyperlink{singletonutils_1_1Vector}{utils\+::\+Vector}$<$ \hyperlink{classtype}{type}, length $>$ \&v)
\end{DoxyCompactItemize}
