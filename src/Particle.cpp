...
Particle::Particle(int type_arg) {
	type = type_arg;
	LOG4CXX_TRACE(Logger::getLogger("MolSim.Particle"), "Particle generated!");
	f = 0.0;
	old_f = 0.0;
}
...
Particle::Particle(const Particle& other) {
	...
	m = other.m;
	type = other.type;
	LOG4CXX_TRACE(Logger::getLogger("MolSim.Particle"), "Particle generated by copy!");
}
...
Particle::~Particle() {
	LOG4CXX_TRACE(Logger::getLogger("MolSim.Particle"), "Particle destructed!");
}
